...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/04 11:09:50 by lolopez           #+#    #+#             */
/*   Updated: 2020/03/10 14:39:44 by lolopez          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int		select_u(t_bag *grossac)
{
	...
	{
		fill_mask_u(grossac, i);
	}
	nb = va_arg(grossac->args, int);
	fill_buff_u(grossac, nb);
...
void	fill_buff_u(t_bag *grossac, int nb)
{
	...
	charnb = ft_utoa_base(nb, "0123456789");
	...
	charbuff = fill_charbuff_u(grossac, &charnb, len);
