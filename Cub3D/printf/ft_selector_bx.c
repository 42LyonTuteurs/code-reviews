...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/04 11:03:02 by lolopez           #+#    #+#             */
/*   Updated: 2020/03/10 14:37:45 by lolopez          ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int		select_bx(t_bag *grossac)
{
	...
	{
		fill_mask_bx(grossac, i);
	}
	nb = va_arg(grossac->args, int);
	fill_buff_bx(grossac, nb);
...
void	fill_buff_bx(t_bag *grossac, int nb)
{
	...
	charbuff = fill_charbuff_bx(grossac, &charnb, len);
